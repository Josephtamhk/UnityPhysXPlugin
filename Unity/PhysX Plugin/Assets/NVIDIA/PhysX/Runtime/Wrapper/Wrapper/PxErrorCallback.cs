...
public partial class PxErrorCallback {
  ...
  private void SwigDirectorConnect() {
    ...
    if (SwigDerivedClassHasMethod("reportError", swigMethodTypes0)) {
      swigDelegate0 = new SwigDelegatePxErrorCallback_0(SwigDirectorreportError);
      swigDelegate0dispatcher = new SwigDelegatePxErrorCallback_0_Dispatcher(SwigDirectorreportError_Dispatcher);
    ...
    NativePINVOKE.PxErrorCallback_director_connect(swigCPtr, swigDelegate0dispatcher, swigDelegate0gcHandlePtr);
  }
  ...
  private void SwigDirectorreportError(int code, string message, string file, int line) {
    reportError((PxErrorCode)code, message, file, line);
  }

  [NativePINVOKE.MonoPInvokeCallback(typeof(SwigDelegatePxErrorCallback_0_Dispatcher))]
  private static void SwigDirectorreportError_Dispatcher(global::System.IntPtr swigDelegatePxErrorCallback_0_Handle, int code, string message, string file, int line) {
    global::System.Runtime.InteropServices.GCHandle gcHandle = global::System.Runtime.InteropServices.GCHandle.FromIntPtr(swigDelegatePxErrorCallback_0_Handle);
    SwigDelegatePxErrorCallback_0 delegateSwigDelegatePxErrorCallback_0 = (SwigDelegatePxErrorCallback_0) gcHandle.Target;
delegateSwigDelegatePxErrorCallback_0(code, message, file, line);
  }
  ...
  public delegate void SwigDelegatePxErrorCallback_0_Dispatcher(global::System.IntPtr swigDelegatePxErrorCallback_0_Handle, int code, string message, string file, int line);

  private SwigDelegatePxErrorCallback_0_Dispatcher swigDelegate0dispatcher;
